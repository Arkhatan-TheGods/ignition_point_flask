...
def routing(app: Flask, data_base: str) -> None:

    args = get_service, data_base, container

    register_customer_routes(app, customers_controller(controller_decorator("CUSTOMER", args)))

    register_product_routes(app, products_controller(controller_decorator("PRODUCT", args)))
